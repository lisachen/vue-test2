                                ...
                                <div class="cart-tab-1">
                                    <div class="cart-item-check">
                                        <a href="javascipt:;" class="checkbox-btn item-check-btn"
                                           :class="{'checked':item.checked==1}" @click="checkProduct(item)">
                                    ...
                                    <div class="cart-item-pic">
                                        <img :src="'../../static/images/'+item.productImage" :alt="item.productName">
                                    </div>
                                    ...
                                    <div class="item-quantity">
                                        <div class="select-self select-self-open">
                                            <div class="select-self-area">
                                                <a class="input-sub" @click="changeQty(item,-1)">-</a>
                                                <input class="select-ipt" v-model="item.productNum">
                                                <a class="input-add" @click="changeQty(item,1)">+</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="cart-tab-4">
                                    <div class="item-price-total">{{item.salePrice * item.productNum | currency('￥')}}
                                    </div>
                                </div>
                    ...
                    <div class="cart-foot-inner">
                        <div class="cart-foot-l">
                            <div class="item-all-check">
                                <a href="javascipt:;" @click="checkAllProduct">
...
<script>
    ...
    export default {
        ...
        methods: {
            getCartList() {
                this.axios.get('/users/cart').then(response => {
            ...
            checkAllProduct() {
                //this.checkedAll = !this.checkedAll;//实时计算没法改变值
